...
const sourceResources = path.join(repositoryRoot, 'resources');
...
await fs.cp(sourceResources, generatedResources, { recursive: true, force: true });
...
console.log('Prepared development SQLite and seed resources.');
